...
var _exercism$xelm$Leap$isLeapYear = function (y) {
	var multipleOf = function (n) {
		return _elm_lang$core$Native_Utils.eq(
			A2(_elm_lang$core$Basics_ops['%'], y, n),
			0);
	};
	return multipleOf(400) || (multipleOf(4) && _elm_lang$core$Basics$not(
		multipleOf(100)));
};
