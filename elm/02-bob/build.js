...
var _exercism$xelm$Bob$isSilence = function (q) {
	return _elm_lang$core$String$isEmpty(
		_elm_lang$core$String$trim(q));
};
var _exercism$xelm$Bob$isQuestion = function (q) {
	return A2(_elm_lang$core$String$endsWith, '?', q);
};
var _exercism$xelm$Bob$isYelling = function (q) {
	return _elm_lang$core$Native_Utils.eq(
		q,
		_elm_lang$core$String$toUpper(q)) && (!_elm_lang$core$Native_Utils.eq(
		q,
		_elm_lang$core$String$toLower(q)));
};
var _exercism$xelm$Bob$cases = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: _exercism$xelm$Bob$isYelling, _1: 'Whoa, chill out!'},
		{ctor: '_Tuple2', _0: _exercism$xelm$Bob$isQuestion, _1: 'Sure.'},
		{ctor: '_Tuple2', _0: _exercism$xelm$Bob$isSilence, _1: 'Fine. Be that way!'}
	]);
var _exercism$xelm$Bob$hey = function (query) {
	var _p0 = _elm_lang$core$List$head(
		A2(
			_elm_lang$core$List$filter,
			function (c) {
				return A2(_elm_lang$core$Basics$fst, c, query);
			},
			_exercism$xelm$Bob$cases));
	if (_p0.ctor === 'Just') {
