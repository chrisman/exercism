...
var _exercism$xelm$Raindrops$cases = _elm_lang$core$Native_List.fromArray(
	[
		...
		function (c) {
			return _elm_lang$core$Native_Utils.eq(
				A2(
					_elm_lang$core$Basics_ops['%'],
					n,
					_elm_lang$core$Basics$fst(c)),
				0);
		},
		_exercism$xelm$Raindrops$cases);
	return _elm_lang$core$List$isEmpty(matches) ? _elm_lang$core$Basics$toString(n) : _elm_lang$core$String$concat(
		A2(_elm_lang$core$List$map, _elm_lang$core$Basics$snd, matches));
};
